...
The zip folder also includes three .csv-files with the datasets you will use to create and analyse a social network model in _Gephi_ (as explained in the tutorial).
