...
## Tasks
In preparation of the course, please install the latest version of [_Gephi_](https://gephi.org/) on the computer you will bring to the summer school, and read [Ch. 6](./Graham_et_al_2016.pdf) of Graham et al. (2016), _Exploring Big Historical Data: The Historian's Macroscope_ (see also [further reading](#furtherreading)). You may also install the software during the 'application dropin' slot on Wednesday 03.08.22, and are welcome to contact Lena (lena.tambs@helsinki.fi) if you have questions or run into problems.
...
## <a id="furtherreading">Further Reading</a>
...
### Gephi
* 
Note also that a number of tutorials are available through the Gephi [webpage](https://gephi.org/users/).