...
Network analysis uses a range of technical terms that can be quite overwelming when forst approaching the methods. To help you keep track on what is what, you might find this [list of technical](./Tambs_NA_Glossary.pdf) terms handy.
...
Finally, we will conclude the module with a plenary discussion in which we can share our thoughts on the exercises and potential of SNA of research in our field(s).