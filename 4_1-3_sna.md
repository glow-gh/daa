...
* download the [4.1-3 SNA zip folder](https://github.com/glow-gh/daa/raw/main/_files/4.4-6_LNA.zip), containing the files we will use in class (a translation, a hands-on tutorial and the datasets you will need to complete it). To practice your newly acqired skills, you may prefer to access the files through _GitHub Desktop_ (as explained in the [1.2 GitHub](./1_2_github.md) section).
