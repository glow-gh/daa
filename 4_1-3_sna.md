...
The three datasets you will need to complete the guide can be downloaded from [here](./_files/Tambs_daa_nodes.csv),[here](./_files/Tambs_daa_edges_1.csv) and [here](./_files/Tambs_daa_edges_2.csv), or accessed through _GitHub Desktop_ (by cloning the daa folder as explained in the [1.2 GitHub](./1_2_github.md) section). For the exercise, we will use them to create a social network model in _Gephi_ (as explained in the tutorial).
