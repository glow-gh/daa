...
For the second practical exercise, please download and follow this [hands-on tutorial](./_files/Tambs_daa_sna_tutorial.pdf). The network file you will need to complete the guide was also placed in the files-folder ([here](./_files/Tambs_daa_network.gexf)), but is best accessed through _GitHub Desktop_ (by cloning the daa folder as explained in the [GitHub](./1_2_github.md) document) so it can be opened from _Gephi_ (as explained in the guide).
