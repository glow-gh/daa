...
The three datasets you will need to complete the guide were put in the files-folder ([here](./_files/Tambs_daa_nodes.csv), [here](./_files/Tambs_daa_edges_1.csv) and [here](./_files/Tambs_daa_edges_2.csv)), but is best accessed through _GitHub Desktop_ (by cloning the daa folder as explained in the [1.2 GitHub](./1_2_github.md) section) or downloading the ZIP-folder from the Summer School's [webpage](https://glow-gh.github.io/daa/).

For the exercise, we will use them to create a social network model in _Gephi_ (as explained in the tutorial).
