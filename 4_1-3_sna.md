...
Network analysis uses a range of technical terms that can be quite overwelming when forst approaching the methods. To help you keep track on what is what, you might find this [list of technical terms](./Tambs_na_glossary.pdf) handy.
