...
* Download [2.1_Python_scripts_data.zip](/daa/_files/2.1_Python_scripts_data.zip) and extract the files. Make sure they are all in the same folder on your computer. 
